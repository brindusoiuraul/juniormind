...
namespace IntArray
{
    public class ListTests
    {
        ...
        [Fact]
        public void TryToReplaceAnItemShouldThrowNotSupportedException()
        {
            List<int> numbers = new List<int>() { 1, 2, 3 };

            numbers.IsReadOnly = true;

            var exception = Assert.Throws<NotSupportedException>(() => numbers[1] = 1);
            Assert.Equal("The list is Read-Only.", exception.Message);
        }

        [Fact]
        public void InsertButShouldThrowNotSupportedException()
        {
            List<int> numbers = new List<int>() { 1, 2, 3 };
        ...
        [Fact]
        public void AddButShouldThrowNotSupportedException()
        {
            List<int> numbers = new List<int>() { 1, 2, 3 };

            numbers.IsReadOnly = true;

            var exception = Assert.Throws<NotSupportedException>(() => numbers.Add(4));
            Assert.Equal("The list is Read-Only.", exception.Message);
        }

        [Fact]
        public void ClearButShouldThrowNotSupportedException()
        {
            List<int> numbers = new List<int>() { 1, 2, 3 };
